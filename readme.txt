...
/**
 * Main plugin file.
 * Manage and deploy configuration changes ...
 *
 * @package      KCMS Cfm
 * @author       KubeeCMS
 * @copyright    Copyright (c) 2012-2020, KubeeCMS - KUBEE
 * @license      GPL-2.0-or-later
 * @link         https://github.com/KubeeCMS/KCMS-Cfm/
 * @link         https://github.com/KubeeCMS/
 *
 * @wordpress-plugin
 * Plugin Name:  KCMS Cfm
 * Plugin URI:   https://github.com/KubeeCMS/KCMS-Cfm/
 * Description:  Manage and deploy configuration changes ...
 * Version:      1.6.0
 * Author:       KubeeCMS - KUBEE
 * Author URI:   https://github.com/KubeeCMS/
 * License:      GPL-2.0-or-later
 * License URI:  https://opensource.org/licenses/GPL-2.0
 * Text Domain:  kcms-cfm
 ...
 *
 *     This file is part of KCMS Additions ...
 *
 *     KCMS Cfm is free software:
...
KCMS CFM lets you copy database configuration to / from the filesystem. Easily deploy configuration changes without needing to copy the entire database. KCMS CFM is similar to Drupal's Features module.

= How will KCMS CFM benefit me? =
...
= Which data does KCMS CFM support? =
...
KCMS CFM supports [pull / push / diff] of bundles from the command-line using [WP-CLI](http://wp-cli.org/):
...
See the filters reference page at the [GitHub Wiki](https://github.com/forumone/KCMS CFM/wiki/Filters-Reference).


== Installation ==

1. Download and activate the plugin.
2. Browse to `Settings > KCMS CFM` to configure.
...
* Fix: Import KCMS CFM settings (props @mickaelperrin)
